 ...
 * 
 * @version $Id: DatabaseHelper.java 888 2011-03-14 19:44:44Z rcgroot@gmail.com $
...
public class DatabaseHelper extends SQLiteOpenHelper
{
   ...
   long insertWaypoint( long trackId, long segmentId, Location location,
         int gsmSignalStrength, int gsmErrorRate)
   {      
      if( trackId < 0 || segmentId < 0 )
      {
         throw new IllegalArgumentException( "Track and segments may not the less then 0." );
      ...
      args.put( WaypointsColumns.GSM_SIGNAL_STRENGTH, gsmSignalStrength);
      args.put( WaypointsColumns.GSM_ERROR_RATE, gsmErrorRate );
