 ...
 * 
 * @version $Id: LoggerMap.java 905 2011-03-22 20:06:20Z rcgroot $
...
public class LoggerMap extends MapActivity
{
   ...
   private CheckBox mSignalStrength;
   ...
   private TextView mLastSignalStrengthView = null;
   ...
   private final OnSharedPreferenceChangeListener mSharedPreferenceChangeListener = new OnSharedPreferenceChangeListener()
      {
         public void onSharedPreferenceChanged( SharedPreferences sharedPreferences, String key )
         {
            ...
            else if( key.equals( Constants.SIGNAL_STRENGTH ) )
            {
               updateSignalStrengthDisplayVisibility();
            }
   ...
   private void setSignalStrengthOverlay( boolean b )
   {
      Editor editor = mSharedPreferences.edit();
      editor.putBoolean( Constants.SIGNAL_STRENGTH, b );
      editor.commit();
   }
   ...
   protected Dialog onCreateDialog( int id )
   {
      ...
      switch (id)
      {
         case DIALOG_LAYERS:
            ...
            mSignalStrength = (CheckBox) view.findViewById( R.id.layer_signalstrength );
            ...
            mSignalStrength.setOnCheckedChangeListener( mCheckedChangeListener );
   ...
   protected void onPrepareDialog( int id, Dialog dialog )
   {
      ...
      switch (id)
      {
         case DIALOG_LAYERS:
            ...
            mSignalStrength.setChecked( mSharedPreferences.getBoolean( Constants.SIGNAL_STRENGTH, false ) );
   ...
   private void updateSignalStrengthDisplayVisibility()
   {
      boolean showsignalstrength = mSharedPreferences.getBoolean( Constants.SIGNAL_STRENGTH, false );
      if( showsignalstrength )
      {
         mLastSignalStrengthView.setVisibility( View.VISIBLE );
         mLastSignalStrengthView.setText( "" );
      }
      else
      {
         mLastSignalStrengthView.setVisibility( View.INVISIBLE );
      }
   }
   ...
   private void updateDisplayedSpeedViews()
   {
      ...
      int lastSignalStrength = mLoggerServiceManager.getLastSignalStrength();
      if( lastWaypoint != null )
      {
         ...
         String signalStrengthText = String.format( "Signal Strength: %d of 31", lastSignalStrength );
         mLastSignalStrengthView.setText( signalStrengthText );
      }
   }
