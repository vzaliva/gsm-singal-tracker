 ...
 *
 * @version $Id: GPStrackingProvider.java 888 2011-03-14 19:44:44Z rcgroot@gmail.com $
      ...
      public Uri insert( Uri uri, ContentValues values )
      {
         ...
         switch (match)
         {
            case WAYPOINTS:
               ...
               Integer gsmSignalStrength = values.getAsInteger( Waypoints.GSM_SIGNAL_STRENGTH );
               Integer gsmErrorRate = values.getAsInteger( Waypoints.GSM_ERROR_RATE );
               
               if( gsmSignalStrength == null ) {
                  gsmSignalStrength = 99;
               }
               if( gsmErrorRate == null ) {
                  gsmErrorRate = 99;
               }
