 ...
 * 
 * @version $Id: GPStracking.java 888 2011-03-14 19:44:44Z rcgroot@gmail.com $
...
public final class GPStracking
{
   ...
   public static final class Waypoints extends WaypointsColumns implements android.provider.BaseColumns
   {
      ...
      "," + " " + WaypointsColumns.GSM_SIGNAL_STRENGTH   + " " + WaypointsColumns.GSM_SIGNAL_STRENGTH_TYPE + 
      "," + " " + WaypointsColumns.GSM_ERROR_RATE + " " + WaypointsColumns.GSM_ERROR_RATE_TYPE + 
      ");";
      ...
      static final String[] UPGRADE_STATEMENT_7_TO_8 = 
         {
            ...
            "ALTER TABLE " + Waypoints.TABLE + " ADD COLUMN " + WaypointsColumns.GSM_SIGNAL_STRENGTH  + " " + WaypointsColumns.GSM_SIGNAL_STRENGTH_TYPE +";",
            "ALTER TABLE " + Waypoints.TABLE + " ADD COLUMN " + WaypointsColumns.GSM_ERROR_RATE  + " " + WaypointsColumns.GSM_ERROR_RATE_TYPE +";"
         };
   }
   ...
   public static class WaypointsColumns
   {
      ...
      /*** BEGIN Henry's Changes ***/
      
      public static final String GSM_SIGNAL_STRENGTH = "gsm_signal_strength";
      public static final String GSM_ERROR_RATE = "gsm_error_rate";
      ...
      /** Henry's Changes */
      static final String GSM_SIGNAL_STRENGTH_TYPE    = "INTEGER NOT NULL";
      static final String GSM_ERROR_RATE_TYPE         = "INTEGER NOT NULL";
